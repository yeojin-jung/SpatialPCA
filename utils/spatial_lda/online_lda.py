    ...
    for idx_d in range(n_samples):
        ...
        for _ in range(0, max_iters):
            ...
            if np.isscalar(doc_topic_prior):
                ...
                _dirichlet_expectation_1d(doc_topic_d, 0, exp_doc_topic_d)
...
class LatentDirichletAllocation(BaseEstimator, TransformerMixin):
    ...
    def _check_params(self):
        ...
        if self.n_topics is not None:
            ...
            warnings.warn(
                "n_topics has been renamed to n_components in "
        ...
        if self._n_components <= 0:
            raise ValueError(
                "Invalid 'n_components' parameter: %r" % self._n_components
            )
    ...
    def _approx_bound(self, X, doc_topic_distr, sub_sampling):
        ...
        score += _loglikelihood(
            doc_topic_prior, doc_topic_distr, dirichlet_doc_topic, self._n_components
        )
    ...
    def perplexity(self, X, doc_topic_distr="deprecated", sub_sampling=False):
        ...
        if doc_topic_distr != "deprecated":
            warnings.warn(
                "Argument 'doc_topic_distr' is deprecated and is "
